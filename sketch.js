...
function draw() {
  ...
  if (particle.body.position.y>=400){
    if(particle.body.position.x<=120){
      score = score+500;
     // particle = null;
    }

    if(particle.body.position.x>140 && particle.body.position.x<=240){
      score = score+100;
     // particle = null;  
    }  

    if(particle.body.position.x>260 && particle.body.position.x<=360){
      score = score+200;
     // particle = null;  
    }  
  }
